...
const systemPromptTemplate = PromptTemplate.fromTemplate(`
  ...
  {{
    ...
    "status": "success"                  // Include status field for success
  }}
  ...
  {{
    ...
    "status": "success"                  // Example status for success
  }}
  ...
  If it's not possible to generate questions, include a status field indicating failure in the response, along with a message explaining the reason for failure in JSON format where it is enclosed in triple backticks and json before the object.
